...
export const SYSTEM_EVENTS = [
  ...
  { name: 'audio:word',         commandable: false, detail: 'speech recognition registered-word trigger (final only)',
    payload: '{ word }' },
  { name: 'audio:word:interim', commandable: false, detail: 'transcription word as it is being spoken',
    payload: '{ word, final, index }' },
  { name: 'audio:word:final',   commandable: false, detail: 'transcription word stabilised / committed',
    payload: '{ word, final, index }' },
  { name: 'audio:transcript',   commandable: false, detail: 'full running transcript (interim or final)',
